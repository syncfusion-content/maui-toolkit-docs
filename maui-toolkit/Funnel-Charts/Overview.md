...
The Syncfusion® Toolkit for [.NET MAUI Funnel Chart](https://www.syncfusion.com/maui-controls/maui-funnel-charts) (SfFunnelChart) provides a visually appealing way to represent data across different stages in a process. It is ideal for analyzing business funnels, such as sales processes or conversion rates, in high-quality .NET MAUI applications.
...
- [Getting Started](https://help.syncfusion.com/maui-toolkit/funnel-charts/getting-started) shows a step‑by‑step guide to begin using the Funnel Chart control.  
- [Appearance](https://help.syncfusion.com/maui-toolkit/funnel-charts/appearance) explains how to customize chart appearance and behavior.  
- [Data Labels](https://help.syncfusion.com/maui-toolkit/funnel-charts/datalabels) helps configure data labels and segment display.  
