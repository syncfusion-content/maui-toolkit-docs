...
![Custom view in .NET MAUI Shimmer.](images/customview/maui-custom-view.gif)

## Shimmer view

[ShimmerView](https://help.syncfusion.com/cr/maui-toolkit/Syncfusion.Maui.Toolkit.Shimmer.ShimmerView.html) can be used to customize the custom view with different shape by using [ShapeType](https://help.syncfusion.com/cr/maui-toolkit/Syncfusion.Maui.Toolkit.Shimmer.ShimmerView.html#Syncfusion_Maui_Toolkit_Shimmer_ShimmerView_ShapeType). The `ShimmerView` is available in three different shape types such as Circle, Rectangle, and RoundedRectangle. By default, the shape type is [Rectangle](https://help.syncfusion.com/cr/maui-toolkit/Syncfusion.Maui.Toolkit.Shimmer.ShimmerShapeType.html#Syncfusion_Maui_Toolkit_Shimmer_ShimmerShapeType_Rectangle).
...
![Custom view in .NET MAUI Shimmer.](images/customview/maui-shimmer-view.gif)