...
- [Linear Progress Bar](https://help.syncfusion.com/maui-toolkit/linearprogressbar/overview) for horizontal progress indication.
- [Pull To Refresh](https://help.syncfusion.com/maui-toolkit/pull-to-refresh/overview) for refresh actions.  
