---
layout: post
title: About Syncfusion® .NET MAUI Carousel | Syncfusion®
...
# About Syncfusion® .NET MAUI Carousel | Syncfusion®
...
- [Getting Started](https://help.syncfusion.com/maui-toolkit/carousel-view/getting-started) shows how to begin using the Carousel control step by step.
- [Populating Data](https://help.syncfusion.com/maui-toolkit/carousel-view/populating-data) explains how to bind collections for dynamic item display.  
- [LoadMore](https://help.syncfusion.com/maui-toolkit/carousel-view/loadmore) shows how to enable incremental loading for large datasets.
