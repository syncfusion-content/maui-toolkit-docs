...
<tr>
<td><a href="/maui-toolkit/calendar/overview" aria-label="MAUI Calendar control overview">Calendar</a></td>
...
- [Date Picker](https://help.syncfusion.com/maui-toolkit/datepicker/overview) for selecting and handling single date input scenarios.
- [DateTime Picker](https://help.syncfusion.com/maui-toolkit/datetimepicker/overview) for selecting combined date and time values.
- [Time Picker](https://help.syncfusion.com/maui-toolkit/timepicker/overview) for choosing specific time inputs.
