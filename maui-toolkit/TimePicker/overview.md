---
layout: post
title: About Syncfusion .NET MAUI Time Picker | Syncfusion®
...
- [Date Picker](https://help.syncfusion.com/maui-toolkit/datepicker/overview) for selecting calendar dates.
- [DateTime Picker](https://help.syncfusion.com/maui-toolkit/datetimepicker/overview) for combined date and time selection.
- [Calendar](https://help.syncfusion.com/maui-toolkit/calendar/overview) for browsing and selecting dates in month view.  

## See Also

- [Getting Started](https://help.syncfusion.com/maui-toolkit/timepicker/getting-started) shows a step‑by‑step guide to begin using the Time Picker control.  
- [Customization](https://help.syncfusion.com/maui-toolkit/timepicker/customizations) explains how to customize layout and appearance.  
- [Formatting](https://help.syncfusion.com/maui-toolkit/timepicker/formatting) helps configure time formats and intervals.  
