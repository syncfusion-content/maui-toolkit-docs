...
- [Chips](https://help.syncfusion.com/maui-toolkit/chips/overview) for compact interactive elements used in selection, filtering, or displaying information.
- [Segmented Control](https://help.syncfusion.com/maui-toolkit/segmented-control/overview) for choosing one option from a set of grouped buttons.
- [Text Input Layout](https://help.syncfusion.com/maui-toolkit/textinputlayout/overview) for structured form fields with labels and validation.

## See Also

- [Getting Started](https://help.syncfusion.com/maui-toolkit/button/getting-started) shows how to begin using the Button control step by step.  
- [Customization](https://help.syncfusion.com/maui-toolkit/button/customization) shows how to customize button appearance and styles.  
- [Visual States](https://help.syncfusion.com/maui-toolkit/button/visual-states) explains how to configure visual states and interactions. 
