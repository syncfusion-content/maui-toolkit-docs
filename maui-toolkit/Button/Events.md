...
The click event occurs when the [Button](https://help.syncfusion.com/cr/maui-toolkit/Syncfusion.Maui.Toolkit.Buttons.SfButton.html) is clicked. The event argument is of type `EventArgs`.
