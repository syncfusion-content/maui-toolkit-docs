...
- [Date Picker](https://help.syncfusion.com/maui-toolkit/datepicker/overview) for date selection.
- [Time Picker](https://help.syncfusion.com/maui-toolkit/timepicker/overview) for time selection.
- [DateTime Picker](https://help.syncfusion.com/maui-toolkit/datetimepicker/overview) for combined date/time input.

## See Also

- [Getting Started](https://help.syncfusion.com/maui-toolkit/picker/getting-started) shows a step‑by‑step guide to begin using the Picker control.  
- [Mode](https://help.syncfusion.com/maui-toolkit/picker/picker-mode) explains how to choose between default, dialog, or custom display styles.  
- [Columns Header](https://help.syncfusion.com/maui-toolkit/picker/dealing-with-column-header) helps add and customize headers for better clarity in multi‑column pickers.  
