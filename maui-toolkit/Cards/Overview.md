...
<tr>
<td><a href="/maui-toolkit/cards/overview" aria-label="MAUI Cards control overview">Cards</a></td>
...
- [Carousel View](https://help.syncfusion.com/maui-toolkit/carousel-view/overview) for swipe-based item navigation using carousel layouts.  
- [Navigation Drawer](https://help.syncfusion.com/maui-toolkit/navigationdrawer/overview) for presenting grouped content in sliding panels.  
- [Accordion](https://help.syncfusion.com/maui-toolkit/accordion/overview) for organizing collapsible content sections.  

## See Also

- [Getting Started](https://help.syncfusion.com/maui-toolkit/cards/getting-started) shows how to begin using the Cards control step by step.  
- [Customization](https://help.syncfusion.com/maui-toolkit/cards/customization) shows how to configure appearance and behavior of cards.
- [Bindable Layout](https://help.syncfusion.com/maui-toolkit/cards/bindablelayout) explains how to bind card items to collections.
