...
The [`SfInteractiveViewer`](https://help.syncfusion.com/cr/maui-toolkit/Syncfusion.Maui.Toolkit.InteractiveViewer.SfInteractiveViewer.html) supports the `ZoomFactorChanged` and `ScrollChanged` events to interact with the .NET MAUI Interactive Viewer.
