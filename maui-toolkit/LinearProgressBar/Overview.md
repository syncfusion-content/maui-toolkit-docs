...
The Syncfusion<sup>&reg;</sup> [.NET MAUI Linear Progress Bar](https://www.syncfusion.com/maui-controls/maui-progressbar) shows the progress of a task with custom visuals. It displays the progress of a process in rectangular shapes, determinate and indeterminate states, segments, and smooth animation. You can also define ranges with different colors.
...
- [Circular Progress Bar](https://help.syncfusion.com/maui-toolkit/circularprogressbar/overview) for radial progress indication.
- [Shimmer](https://help.syncfusion.com/maui-toolkit/shimmer/overview) for loading placeholders.
- [Numeric Entry](https://help.syncfusion.com/maui-toolkit/numericentry/overview) for direct numeric input.

## See Also

- [Getting Started](https://help.syncfusion.com/maui-toolkit/linearprogressbar/getting-started) shows a step‑by‑step guide to begin using the Linear Progress Bar control.  
- [Appearance](https://help.syncfusion.com/maui-toolkit/linearprogressbar/appearance) explains how to customize appearance and behavior.  
- [States](https://help.syncfusion.com/maui-toolkit/linearprogressbar/states) helps configure progress states and behavior.  
