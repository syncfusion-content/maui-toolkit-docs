...
The .NET MAUI OTP Input (`SfOtpInput`) control is used to capture one-time passwords (OTP) in a structured and user-friendly format. It simplifies the process of entering verification codes received through SMS, email, or authentication apps, improving usability and security in .NET MAUI applications.

![.NET MAUI OTP Input](images/overview.png)

## Business use cases

- Authentication systems that require secure OTP-based verification for login and account access.  
- Banking and financial applications that use multi-factor authentication with OTP validation.  
- E-commerce applications that perform transaction verification using one-time passwords.  
- Enterprise applications that enforce secure user identity confirmation and access control.  

## Key features

- **OTP length configuration support** allows defining the number of input fields based on OTP requirements.  
- **Styling mode support** allows choosing visual styles such as outlined, filled, or underlined input fields.  
- **Input type support** allows configuring field types such as numeric, text, or password for secure entry.  
- **Separator support** allows adding custom separators between input fields for better readability.  
- **Structured input layout support** allows improving user experience with clear and segmented input fields.  
...
<tr>
<td><a href="/maui-toolkit/otp-inout/overview">OtpInput</a></td>
...
- [Numeric UpDown](https://help.syncfusion.com/maui-toolkit/numericupdown/overview) for controlled numeric adjustments with increment/decrement buttons, offering another structured input option.
...
<div class="form-card" target="_blank">
  ...
  <div class="card-header">
    ...
    <a href="https://www.syncfusion.com/tutorial-videos/maui/otp-input" class="explore-link">
    Watch now
  <span class="card-icon card-arrow"></span>
</a>
  </div>
...
<div class="form-card" target="_blank">
  <div class="form-content">
   <div class="card-header">
    ...
    <a href="https://support.syncfusion.com/kb/cross-platforms/section/2262" class="explore-link">
Search KB's
  <span class="card-icon card-arrow"></span>
</a>
  </div>
