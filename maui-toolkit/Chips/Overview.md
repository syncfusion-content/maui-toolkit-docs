...
- [Button](https://help.syncfusion.com/maui-toolkit/button/overview) for simple action triggers.
- [Segmented Control](https://help.syncfusion.com/maui-toolkit/segmented-control/overview) for grouped option selection.
- [Text Input Layout](https://help.syncfusion.com/maui-toolkit/textinputlayout/overview) for structured form inputs with labels.

## See Also

- [Getting Started](https://help.syncfusion.com/maui-toolkit/chips/getting-started) shows a step‑by‑step guide to begin using the Chips control.  
- [Chip Types](https://help.syncfusion.com/maui-toolkit/chips/chips-types) explores different chip variations such as input, choice, filter, and action chips, and explains how each type can be used to represent data or user actions.  
- [Customization](https://help.syncfusion.com/maui-toolkit/chips/customization) helps personalize chip appearance by modifying styles, colors, icons, and templates to match your application’s design.  
