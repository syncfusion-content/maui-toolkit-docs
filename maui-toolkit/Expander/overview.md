...
- [Accordion](https://help.syncfusion.com/maui-toolkit/accordion/overview) for managing multiple expandable sections in a grouped layout.  
- [Navigation Drawer](https://help.syncfusion.com/maui-toolkit/navigationdrawer/overview) for slide‑in panels.
- [Tab View](https://help.syncfusion.com/maui-toolkit/tabview/overview) for organizing content into tabs.

## See Also

- [Getting Started](https://help.syncfusion.com/maui-toolkit/expander/getting-started) shows a step‑by‑step guide to begin using the Expander control.  
- [Appearance](https://help.syncfusion.com/maui-toolkit/expander/appearance) explains how to customize header and content appearance.  
