...
The `SfExpander` allows you to customize the position of the header icon by using the [HeaderIconPosition](https://helpstaging.syncfusion.com:14038/cr/maui-toolkit/Syncfusion.Maui.Toolkit.Expander.SfExpander.html#Syncfusion_Maui_Toolkit_Expander_SfExpander_HeaderIconPosition) property. By default, the header icon position is `End`.
...
The `SfExpander` allows you to customize the background color of the expander header by using the [HeaderBackground](https://helpstaging.syncfusion.com:14038/cr/maui-toolkit/Syncfusion.Maui.Toolkit.Expander.SfExpander.html#Syncfusion_Maui_Toolkit_Expander_SfExpander_HeaderBackground) property.
...
The `SfExpander` allows you to customize the color of the expander icon by using the [HeaderIconColor](https://helpstaging.syncfusion.com:14038/cr/maui-toolkit/Syncfusion.Maui.Toolkit.Expander.SfExpander.html#Syncfusion_Maui_Toolkit_Expander_SfExpander_HeaderIconColor) property.
