...
Before installing Syncfusion® .NET MAUI Toolkit Agent Skills, ensure the following:

- Required [Node.js](https://nodejs.org/en/) version >= 16
- MAUI application (existing or new); see [Quick Start](https://help.syncfusion.com/maui-toolkit/introduction/overview)
...
Install [Syncfusion® .NET MAUI Toolkit components skills](https://github.com/syncfusion/maui-toolkit-ui-components-skills) using the Skills CLI. Users can also explore available skills from the [marketplace](https://skills.sh/syncfusion/).
...
npx skills add syncfusion/maui-toolkit-ui-components-skills -y
...
│  ◻ syncfusion-maui-toolkit-popup
│  ◻ syncfusion-maui-toolkit-shimmer
│  ◻ syncfusion-maui-toolkit-chips
│  ◻ syncfusion-maui-toolkit-carousel
...
Once skills are installed, the assistant can be used to generate and update Syncfusion® .NET MAUI Toolkit code for tasks such as:
...
After installation, manage Syncfusion® Toolkit Agent Skills using the following commands:
...
Replace `<skill-name>` with the name of the skill you want to remove (for example, `syncfusion-maui-toolkit-button`).
...
Yes. Once installed, supported agents automatically detect and load relevant skills for Syncfusion Toolkit‑related queries without requiring additional configuration.
