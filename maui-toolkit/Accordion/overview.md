...
- [Expander](https://help.syncfusion.com/maui-toolkit/expander/overview) for expanding and collapsing a single content section.
- [Navigation Drawer](https://help.syncfusion.com/maui-toolkit/navigationdrawer/overview) for slide‑in navigation panels and grouped menus.
- [Tab View](https://help.syncfusion.com/maui-toolkit/tabview/overview) for organizing content into tabbed sections.

## See Also

- [Getting Started](https://help.syncfusion.com/maui-toolkit/accordion/getting-started) shows how to begin using the Accordion step by step.
- [Bindable Layout](https://help.syncfusion.com/maui-toolkit/accordion/bindablelayout) explains how to bind Accordion items to collections.
- [Events](https://help.syncfusion.com/maui-toolkit/accordion/events) show how to handle interactions and customize behavior.
