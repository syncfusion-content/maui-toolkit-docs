...
The `Placement` property uses the [LegendPlacement](https://help.syncfusion.com/cr/maui-toolkit/Syncfusion.Maui.Toolkit.Charts.LegendPlacement.html) enum, which provides the following values:
